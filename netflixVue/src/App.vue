<template>
  <div class="contain">
    <categoria v-for="categoria in categorias" v-bind:key="categoria.id" v-bind:titulo="categoria.titulo" v-bind:filmes="categoria.filmes" ref="acao"></categoria>
  </div>
</template>
